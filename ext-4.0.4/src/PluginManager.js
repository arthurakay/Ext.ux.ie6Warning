 ...
 *     'gridviewdragdrop'
 * 
 * Alternatively you can instanciate the plugin with Ext.create:
 * 
...
Ext.define('Ext.PluginManager', {
     ...
     * @param {Constructor} defaultType The constructor to provide the default Plugin type if the config object does not
