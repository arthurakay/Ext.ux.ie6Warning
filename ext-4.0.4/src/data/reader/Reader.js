 ...
 * Ext.data.Store Store} - usually in response to an AJAX request. This is normally handled transparently by passing
 * some configuration to either the {@link Ext.data.Model Model} or the {@link Ext.data.Store Store} in question - see
 * their documentation for further details.
 *
 * # Loading Nested Data
 *
