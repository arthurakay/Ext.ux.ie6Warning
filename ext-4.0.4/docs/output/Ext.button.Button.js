  ...
  "members": {
    ...
    "property": [
      ...
      },
      {
        ...
        "name": "menu",
        "owner": "Ext.button.Button",
        "doc": "<p>The <a href=\"#/api/Ext.menu.Menu\" rel=\"Ext.menu.Menu\" class=\"docClass\">Menu</a> object associated with this Button when configured with the <a href=\"#/api/Ext.button.Button-cfg-menu\" rel=\"Ext.button.Button-cfg-menu\" class=\"docClass\">menu</a> config option.</p>\n"
      },
      {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "name": "arrowAlign",
        "owner": "Ext.button.Button",
        "doc": "<p>(Optional) The side of the Button box to render the arrow if the button has an associated <a href=\"#/api/Ext.button.Button-cfg-menu\" rel=\"Ext.button.Button-cfg-menu\" class=\"docClass\">menu</a>.\nTwo values are allowed:</p>\n\n\n<ul class=\"mdetail-params\">\n<li>'right'<div class=\"sub-desc\"></div></li>\n<li>'bottom'<div class=\"sub-desc\"></div></li>\n</ul>\n\n\n<p>Defaults to <b><tt>'right'</tt></b>.</p>\n\n"
      },
      {
        "type": "String",
