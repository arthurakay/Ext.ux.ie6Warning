Ext.data.JsonP.Ext_ElementLoader({
  ...
  "members": {
    "method": [
      ...
      {
        "shortDoc": "Sets an Ext.core.Element as the target of this loader. ...",
        "params": [
          {
            "type": "Mixed",
            "optional": false,
        ...
        "name": "setTarget",
        "owner": "Ext.ElementLoader",
        "doc": "<p>Sets an <a href=\"#/api/Ext.core.Element\" rel=\"Ext.core.Element\" class=\"docClass\">Ext.core.Element</a> as the target of this loader.\nNote that if the target is changed, any active requests will be aborted.</p>\n"
      },
      {
    ...
    "cfg": [
      ...
      },
      {
        ...
        "type": "HTMLElement/Ext.core.Element/String",
        ...
        "name": "target",
        "owner": "Ext.ElementLoader",
        "doc": "<p>The target element for the loader. It can be the DOM element, the id or an <a href=\"#/api/Ext.core.Element\" rel=\"Ext.core.Element\" class=\"docClass\">Ext.core.Element</a>.</p>\n"
      },
      {
  ...
  "doc": "<p>A class used to load remote content to an Element. Sample usage:</p>\n\n<pre><code>Ext.get('el').load({\n    url: 'myPage.php',\n    scripts: true,\n    params: {\n        id: 1\n    }\n});\n</code></pre>\n\n<p>In general this class will not be instanced directly, rather the <a href=\"#/api/Ext.core.Element-event-load\" rel=\"Ext.core.Element-event-load\" class=\"docClass\">Ext.core.Element.load</a> method\nwill be used.</p>\n",
  "extends": "Ext.Base",
  "docauthor": null
});