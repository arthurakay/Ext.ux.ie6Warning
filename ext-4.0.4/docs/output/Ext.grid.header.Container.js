  ...
  "members": {
    "method": [
        ...
        "params": [
          {
            "type": "...Object/Array",
            "optional": false,
            "doc": "<p>Either one or more Components to add or an Array of Components to add.\nSee <code><a href=\"#/api/Ext.grid.header.Container-cfg-items\" rel=\"Ext.grid.header.Container-cfg-items\" class=\"docClass\">items</a></code> for additional information.</p>\n",
            "name": "Component"
          }
        ],
      ...
      },
      {
        ...
        "name": "getComponent",
        "owner": "Ext.container.AbstractContainer",
        "doc": "<p>Examines this container's <code><a href=\"#/api/Ext.grid.header.Container-cfg-items\" rel=\"Ext.grid.header.Container-cfg-items\" class=\"docClass\">items</a></code> <b>property</b>\nand gets a direct child component of this container.</p>\n"
      },
      {
