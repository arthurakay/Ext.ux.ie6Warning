        ...
        "params": [
          {
            "type": "...Object/Array",
            "optional": false,
            "doc": "<p>Either one or more Components to add or an Array of Components to add.\nSee <code><a href=\"#/api/Ext.grid.property.Grid-cfg-items\" rel=\"Ext.grid.property.Grid-cfg-items\" class=\"docClass\">items</a></code> for additional information.</p>\n",
            "name": "Component"
          }
        ],
    ...
    "property": [
      {
        ...
        "name": "dd",
        "owner": "Ext.panel.Panel",
        "doc": "<p>If this Panel is configured <a href=\"#/api/Ext.grid.property.Grid-cfg-draggable\" rel=\"Ext.grid.property.Grid-cfg-draggable\" class=\"docClass\">draggable</a>, this property will contain\nan instance of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a> which handles dragging the Panel.</p>\n\n\n<p>The developer must provide implementations of the abstract methods of <a href=\"#/api/Ext.dd.DragSource\" rel=\"Ext.dd.DragSource\" class=\"docClass\">Ext.dd.DragSource</a>\nin order to supply behaviour for each stage of the drag/drop process. See <a href=\"#/api/Ext.grid.property.Grid-cfg-draggable\" rel=\"Ext.grid.property.Grid-cfg-draggable\" class=\"docClass\">draggable</a>.</p>\n"
      },
      {
        "type": "Boolean",
